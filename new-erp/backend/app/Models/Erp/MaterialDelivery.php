...
class MaterialDelivery extends MasterModel
{
    ...
    protected $casts = [
        'departed_at' => 'datetime', 'delivered_at' => 'datetime',
        'assigned_at' => 'datetime', 'claimed_at' => 'datetime', 'business_version' => 'integer',
    ];
    ...
    public function deliveryWave() { return $this->belongsTo(MaterialDeliveryWave::class, 'delivery_wave_id'); }
