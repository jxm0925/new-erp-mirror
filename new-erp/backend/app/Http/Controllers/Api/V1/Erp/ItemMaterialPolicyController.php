...
class ItemMaterialPolicyController extends Controller
{
    ...
    private function validated(Request $request, bool $activation): array
    {
        return $request->validate([
            ...
            'production_execution_mode' => 'sometimes|in:unit,quantity',
            'serial_generation_stage' => 'sometimes|in:production_unit_created,routing_operation_completed,before_finished_goods_posting',
            'serial_generation_routing_operation_id' => 'nullable|integer|exists:erp_production_routing_operations,id',
