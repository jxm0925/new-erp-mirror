...
class ItemIntegratedFormController extends Controller
{
    ...
    private function validated(Request $request, ?int $id = null): array
    {
        ...
        $policyRules = [
            ...
            'policy.production_execution_mode' => 'sometimes|in:unit,quantity',
            'policy.serial_generation_stage' => 'sometimes|in:production_unit_created,routing_operation_completed,before_finished_goods_posting',
            'policy.serial_generation_routing_operation_id' => 'nullable|integer|exists:erp_production_routing_operations,id',
