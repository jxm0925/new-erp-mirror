...
class RbacBootstrapService
{
    ...
    private function seedPermissions(bool $force = false): bool
    {
        $permissions = [
            ...
            ['production.report.create', '提交生产报工', 'button', 'production.work_order', null, null, 'el-icon-mouse', 27],
            ['production.completion.view', '查看工单完工事实', 'button', 'production.work_order', null, null, 'el-icon-view', 27],
            ['production.completion.create', '提交工单完工', 'button', 'production.work_order', null, null, 'el-icon-mouse', 27],
            ['production.completion.review', '审核工单完工', 'button', 'production.work_order', null, null, 'el-icon-check', 27],
    ...
    private function ensureProductionRolePermissions(): void
    {
        $permissionIds = DB::table('erp_rbac_permissions')
            ->whereIn('code', [
                ...
                'production.material_delivery.confirm', 'production.material_delivery.cancel', 'production.material_receipt.view', 'production.material_receipt.confirm',
                ...
                'production.report.create', 'production.completion.view', 'production.completion.create', 'production.completion.review',
        ...
        $matrix = [
            ...
            'production_operator' => [
                ...
                'production.task.view', 'production.task.claim', 'production.task.start', 'production.task.pause', 'production.task.resume', 'production.task.complete', 'production.task.collaborate',
                'production.report.create', 'production.completion.view', 'production.completion.create',
