...
use App\Http\Controllers\Api\V1\Erp\ProductionDeliveryTriggerController;
...
use App\Http\Controllers\Api\V1\Erp\ProductionTaskController;
use App\Http\Controllers\Api\V1\Erp\ProductionExecutionController;
use App\Http\Controllers\Api\V1\Erp\ProductionExecutionMonitorController;
use App\Http\Controllers\Api\V1\Erp\ProductionHandoverController;
use App\Http\Controllers\Api\V1\Erp\ProductionOutputController;
use App\Http\Controllers\Api\V1\Erp\CuttingController;
use App\Http\Controllers\Api\V1\Erp\ProductionMaterialSupplementController;
use App\Http\Controllers\Api\V1\Erp\ProductionMaterialReturnController;
use App\Http\Controllers\Api\V1\Erp\ProductionUnitTraceController;
use App\Http\Controllers\Api\V1\Erp\ProductionInternalIssueController;
use App\Http\Controllers\Api\V1\Erp\ProductionLaborAllocationRuleController;
use App\Http\Controllers\Api\V1\Erp\ProductionLaborStatisticsController;
...
Route::prefix('v1/erp/sales')->group(function () {
    ...
    Route::post('orders/{id}/lock-inventory', [SalesOrderController::class, 'lockInventory'])->whereNumber('id');
...
Route::prefix('v1/erp/production')->group(function () {
    Route::get('cutting/demands', [CuttingController::class, 'demands']);
    Route::post('cutting/demands/generate', [CuttingController::class, 'generateDemand']);
    Route::get('cutting/demands/{id}', [CuttingController::class, 'demand'])->whereNumber('id');
    Route::post('cutting/demands/{id}/revisions', [CuttingController::class, 'reviseDemand'])->whereNumber('id');
    Route::get('cutting/configurations', [CuttingController::class, 'configurations']);
    Route::post('cutting/configurations', [CuttingController::class, 'createConfiguration']);
    Route::get('cutting/configurations/{id}', [CuttingController::class, 'configuration'])->whereNumber('id');
    Route::put('cutting/configurations/{id}', [CuttingController::class, 'updateConfiguration'])->whereNumber('id');
    ...
    Route::post('cutting/material-physicals/{id}/dispose', [CuttingController::class, 'disposePhysical'])->whereNumber('id');
    ...
    Route::post('cutting/settlements/{id}/return-original', [CuttingController::class, 'returnOriginal'])->whereNumber('id');
    Route::post('cutting/settlements/{id}/submit', [CuttingController::class, 'submit'])->whereNumber('id');
    Route::post('cutting/settlements/{id}/confirm', [CuttingController::class, 'confirm'])->whereNumber('id');
    Route::post('cutting/settlements/{id}/reverse-confirmation', [CuttingController::class, 'reverseConfirmation'])->whereNumber('id');
    ...
    Route::get('cutting/inventory-reservations', [CuttingController::class, 'inventoryReservations']);
    Route::post('cutting/inventory-reservations/{id}/issue', [CuttingController::class, 'createInventoryIssue'])->whereNumber('id');
    Route::post('cutting/inventory-reservations/{id}/release', [CuttingController::class, 'releaseInventory'])->whereNumber('id');
    Route::post('cutting/inventory-issues/{id}/cancel', [CuttingController::class, 'cancelInventoryIssue'])->whereNumber('id');
    ...
    Route::post('preparation-lines/{id}/delivery-trigger', [ProductionDeliveryTriggerController::class, 'configure'])->whereNumber('id');
    Route::post('preparation-lines/{id}/manual-release-delivery', [ProductionDeliveryTriggerController::class, 'manualRelease'])->whereNumber('id');
    ...
    Route::post('delivery-tasks/{id}/transition', [ProductionDeliveryWaveController::class, 'transition'])->whereNumber('id');
    ...
    Route::get('outputs/{id}', [ProductionOutputController::class, 'show'])->whereNumber('id');
    Route::post('outputs/{id}/quality-inspect', [ProductionOutputController::class, 'inspect'])->whereNumber('id');
    Route::post('outputs/{id}/warehouse', [ProductionOutputController::class, 'warehouse'])->whereNumber('id');
    Route::get('material-supplements', [ProductionMaterialSupplementController::class, 'index']);
    Route::post('material-supplements', [ProductionMaterialSupplementController::class, 'store']);
    Route::get('material-supplements/{id}', [ProductionMaterialSupplementController::class, 'show'])->whereNumber('id');
    Route::post('material-supplements/{id}/decision', [ProductionMaterialSupplementController::class, 'decide'])->whereNumber('id');
    Route::get('material-returns', [ProductionMaterialReturnController::class, 'index']);
    Route::post('material-returns', [ProductionMaterialReturnController::class, 'store']);
    Route::get('material-returns/{id}', [ProductionMaterialReturnController::class, 'show'])->whereNumber('id');
    Route::post('material-returns/{id}/receive', [ProductionMaterialReturnController::class, 'receive'])->whereNumber('id');
    Route::post('material-returns/{id}/quality', [ProductionMaterialReturnController::class, 'quality'])->whereNumber('id');
    Route::get('work-orders/{id}/units', [ProductionUnitTraceController::class, 'workOrderUnits'])->whereNumber('id');
    Route::get('units/{id}', [ProductionUnitTraceController::class, 'unit'])->whereNumber('id');
    Route::get('trace', [ProductionUnitTraceController::class, 'trace']);
    Route::get('internal-issues', [ProductionInternalIssueController::class, 'index']);
    ...
    Route::post('material-picking-tasks/{id}/assign', [ProductionMaterialExecutionController::class, 'assignPickingTask'])->whereNumber('id');
    Route::post('material-picking-tasks/{id}/start', [ProductionMaterialExecutionController::class, 'startPickingTask'])->whereNumber('id');
    Route::post('material-picking-tasks/{id}/confirm', [ProductionMaterialExecutionController::class, 'confirmPickingTask'])->whereNumber('id');
    Route::post('material-picking-tasks/{id}/cancel', [ProductionMaterialExecutionController::class, 'cancelPickingTask'])->whereNumber('id');
    Route::get('material-deliveries', [ProductionMaterialExecutionController::class, 'deliveries']);
    Route::post('material-deliveries', [ProductionMaterialExecutionController::class, 'createDelivery']);
    Route::get('material-deliveries/{id}', [ProductionMaterialExecutionController::class, 'showDelivery'])->whereNumber('id');
    Route::post('material-deliveries/{id}/dispatch', [ProductionMaterialExecutionController::class, 'dispatchDelivery'])->whereNumber('id');
    Route::post('material-deliveries/{id}/deliver', [ProductionMaterialExecutionController::class, 'deliverDelivery'])->whereNumber('id');
    Route::post('material-deliveries/{id}/receive', [ProductionMaterialExecutionController::class, 'receiveDelivery'])->whereNumber('id');
    Route::post('material-deliveries/{id}/cancel', [ProductionMaterialExecutionController::class, 'cancelDelivery'])->whereNumber('id');
    Route::get('material-receipts/{id}', [ProductionMaterialExecutionController::class, 'showReceipt'])->whereNumber('id');
});
